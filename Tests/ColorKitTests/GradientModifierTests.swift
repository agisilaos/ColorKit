...
final class GradientModifierTests: XCTestCase {
    ...
    func testLinearGradientModifierExists() {
        ...
        let view = Text("Test")
        _ = view.linearGradientBackground(
            from: .red,
            to: .blue,
    ...
    func testComplementaryGradientModifierExists() {
        // Compile-time test: verify the method exists and accepts the right parameters
        let view = Text("Test")
        _ = view.complementaryGradientBackground(
            from: .red,
            direction: .topToBottom,
            in: .hsl,
            steps: 10
    ...
    func testAnalogousGradientModifierExists() {
        // Compile-time test: verify the method exists and accepts the right parameters
        let view = Text("Test")
        _ = view.analogousGradientBackground(
            from: .red,
            direction: .topToBottom,
            angle: 0.0833,
            in: .hsl,
    ...
    func testTriadicGradientModifierExists() {
        // Compile-time test: verify the method exists and accepts the right parameters
        let view = Text("Test")
        _ = view.triadicGradientBackground(
            from: .red,
            direction: .topToBottom,
            in: .hsl,
            steps: 5
    ...
    func testMonochromaticGradientModifierExists() {
        // Compile-time test: verify the method exists and accepts the right parameters
        let view = Text("Test")
        _ = view.monochromaticGradientBackground(
            from: .red,
            direction: .topToBottom,
    ...
    func testDefaultParameterValues() {
        ...
        let view1 = Text("Test")
        _ = view1.linearGradientBackground(
            from: .red,
            to: .blue
        )
        ...
        let view2 = Text("Test")
        _ = view2.complementaryGradientBackground(
            from: .red
        )

        // Analogous gradient with minimal parameters
        let view3 = Text("Test")
        _ = view3.analogousGradientBackground(
            from: .red
        )

        // Triadic gradient with minimal parameters
        let view4 = Text("Test")
        _ = view4.triadicGradientBackground(
            from: .red
        )

        // Monochromatic gradient with minimal parameters
        let view5 = Text("Test")
        _ = view5.monochromaticGradientBackground(
            from: .red
        )
