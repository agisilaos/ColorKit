...
ColorKit 3.0.0 shipped the deprecated adapter. [ADR 0013](0013-preserve-shipped-3x-client-contracts.md) supersedes the removal schedule and preserves it through 3.x; the distinction between CIEDE2000 and legacy RGB distance remains in force.
